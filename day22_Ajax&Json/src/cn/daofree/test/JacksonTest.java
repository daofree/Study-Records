...
import cn.daofree.domain.Person;
...
//        System.out.println(json);
        ...
        objectMapper.writeValue(new File("e://a.txt"),p);

        //writeValue.将数据关联到Writer中
        objectMapper.writeValue(new FileWriter("e://b.txt"),p);
    }
    ...
    public void test2() throws Exception {
        ...
        System.out.println(json);//{"name":"张三","age":23,"gender":"男","birthday":1581869781822}
        // {"name":"张三","age":23,"gender":"男","birthday":"2020-02-16"}
    }
